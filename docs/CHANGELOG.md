...
* BREAKING: \#8 Changed exposed ports from 80 and 443 to 8081 and 8440 to make it possible to run the container in environments where lower ports are not allowed.
